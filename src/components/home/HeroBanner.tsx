    ...
    <section className="relative overflow-hidden pt-3 pb-6 sm:py-6">
      <div className="w-full px-4 sm:px-8 lg:px-12 xl:px-16 2xl:px-20 mx-auto">
        ...
        <div className={`relative rounded-3xl sm:rounded-3xl overflow-hidden bg-gradient-to-br ${slide.bgGradient} text-white shadow-xl transition-all duration-700`}>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center p-6 sm:p-10 lg:p-14 xl:p-16">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-2.5">
                <span className="px-3.5 py-1.5 bg-accent-400 text-brand-950 font-black text-xs sm:text-sm uppercase tracking-wider rounded-xl shadow-sm flex items-center gap-1.5">
                  <Sparkles className="w-4 h-4" />
                  {slide.tag}
                </span>

                <span className="px-3.5 py-1.5 bg-white/10 backdrop-blur-md text-brand-100 font-bold text-xs sm:text-sm rounded-xl border border-white/15 flex items-center gap-1.5">
                  <Leaf className="w-3.5 h-3.5 text-brand-300" />
                  {slide.accentBadge}
                </span>
              </div>
              ...
              {/* Subheadline */}
              <p className="text-base sm:text-lg lg:text-xl text-brand-100/95 leading-relaxed max-w-2xl font-normal">
                {slide.subtitle}
              </p>

              {/* Promo code pill */}
              <div className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-md p-2 pr-5 rounded-2xl border border-white/20 text-sm">
                <span className="px-3 py-1 bg-accent-400 text-brand-950 font-black rounded-xl text-xs sm:text-sm">
                  {slide.promoCode}
                </span>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
                <Link
                  href={slide.ctaLink}
                  className="px-7 py-4 bg-accent-400 hover:bg-accent-300 text-brand-950 font-black text-sm sm:text-base rounded-2xl shadow-lg shadow-accent-500/25 flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95"
                >
                ...
                <Link
                  href="/subscriptions"
                  className="px-6 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-bold text-sm sm:text-base rounded-2xl border border-white/20 flex items-center justify-center transition-colors"
                >
                  Subscribe & Save 18%
                </Link>
              </div>
              ...
              <div className="pt-1.5 flex items-center gap-2 text-xs sm:text-sm text-brand-200">
            ...
            <div className="lg:col-span-5 relative mt-4 lg:mt-0">
              <div className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-square w-full rounded-3xl overflow-hidden shadow-2xl border-4 border-white/10">
                <Image
                  src={slide.image}
                  alt={slide.title}
                  fill
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md p-3.5 rounded-2xl shadow-lg border border-brand-100 flex items-center justify-between text-gray-900">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-brand-100 text-brand-800 flex items-center justify-center font-bold text-xl">
                      ⏰
                    </div>
                    <div>
                      ...
                      <div className="text-xs sm:text-sm font-black text-gray-900">
                        Sealdah Koley Mandi: 03:45 AM
                      </div>
                    </div>
                  </div>
                  <span className="text-xs font-black px-2.5 py-1 bg-brand-100 text-brand-800 rounded-lg">
                    100% FRESH
                  </span>
                </div>
              </div>
