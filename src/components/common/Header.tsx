  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-xs transition-all w-full max-w-full">
          ...
          <div className="flex items-center justify-between h-16 sm:h-20 gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              <Link href="/" className="flex items-center gap-2 group">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center shadow-md shadow-brand-500/20 group-hover:scale-105 transition-transform">
              ...
              <button
                ...
                className="hidden md:flex items-center gap-2 text-left px-3 py-1.5 rounded-2xl bg-brand-50 hover:bg-brand-100 border border-brand-200/70 transition-all max-w-[160px] lg:max-w-[200px]"
                title="Change Kolkata delivery locality"
              >
                <div className="p-1 rounded-xl bg-brand-600 text-white shrink-0">
                  <MapPin className="w-3.5 h-3.5" />
                </div>
                <div className="truncate">
                  <div className="text-[10px] font-bold text-emerald-900 uppercase leading-none">Delivering to</div>
                  <div className="text-xs sm:text-sm font-extrabold text-gray-900 truncate leading-tight mt-0.5 flex items-center gap-1">
            ...
            {/* Big Rounded Search Bar (flex-1 with min-w-0 to prevent overflow) */}
            <div className="flex-1 min-w-0 max-w-xl mx-2 sm:mx-4">
              <button
                type="button"
                onClick={() => setIsSearchOpen(true)}
                className="w-full h-11 sm:h-12 pl-3.5 pr-2.5 bg-gray-50 hover:bg-gray-100/90 border border-gray-200 focus:border-brand-500 rounded-2xl flex items-center justify-between text-left transition-all shadow-inner group"
              >
            ...
            {/* Right Nav Actions: Sign In + Cart (Always Visible & In View) */}
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              {/* Mobile location button */}
              <button
                onClick={openLocationModal}
                className="md:hidden p-2 text-brand-800 hover:bg-brand-50 rounded-xl transition-colors"
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 text-xs sm:text-sm font-bold text-gray-700 hover:text-brand-800 hover:bg-brand-50 rounded-2xl border border-gray-200 hover:border-brand-200 transition-all shrink-0"
              >
              ...
              <Link
                href="/cart"
                className="relative flex items-center gap-2 sm:gap-3 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-2xl bg-brand-600 hover:bg-brand-700 text-white shadow-md shadow-brand-600/25 transition-all hover:scale-[1.02] active:scale-[0.98] shrink-0"
              >
        ...
        <div className="border-t border-gray-100 bg-gray-50/90 px-4 sm:px-6 lg:px-8 py-2 overflow-x-auto no-scrollbar w-full max-w-full">
          <div className="w-full flex items-center justify-between gap-4 text-xs font-bold text-gray-700 whitespace-nowrap">
